...
const Form = () => {
    ...
    const [formdata, setFormdata] = useState({
        ...
        content: `
        <h3><strong>Hi Sir/Mam,</strong></h3><p>I am Janardh,</p><p>I have almost 3.2 years of experience as a Sr. Full Stack Developer in I3matrix, expertise in the following languages and technologies:</p><ul><li><strong>React JS</strong></li><li><strong>Node JS</strong></li><li><strong>Next JS</strong></li><li><strong>Express JS</strong></li><li><strong>MySQL</strong></li><li><strong>PHP</strong></li><li><strong>Rest API</strong></li><li><strong>GitHub</strong></li><li><strong>AWS</strong></li><li><strong>Microservices</strong></li><li><strong>HTML</strong></li><li><strong>CSS</strong></li><li><strong>JavaScript</strong></li><li><strong>jQuery</strong></li><li><strong>Bootstrap</strong></li></ul><p>I possess strong logical skills, enabling me to adapt to new technologies and projects efficiently.</p><h3><strong>Professional Details</strong>:</h3><ul><li><strong>Total Experience:</strong> 3.2 years</li><li><strong style="color: rgba(0, 0, 0, 0.9);">Experience in React.js:</strong><span style="color: rgba(0, 0, 0, 0.9);"> </span>3.2 years</li><li><strong>Experience in Node.js:</strong> 3.2 years</li><li><strong style="color: rgba(0, 0, 0, 0.9);">Experience in JavaScript:</strong><span style="color: rgba(0, 0, 0, 0.9);"> </span>3.2 years</li><li><strong style="color: rgba(0, 0, 0, 0.9);">Experience in PHP:</strong><span style="color: rgba(0, 0, 0, 0.9);"> 4months</span></li><li><strong style="color: rgba(0, 0, 0, 0.9);">Experience in </strong><strong>Express JS</strong><strong style="color: rgba(0, 0, 0, 0.9);">:</strong><span style="color: rgba(0, 0, 0, 0.9);"> </span>3.2 years</li><li><strong>Current CTC:</strong> 5.5 LPA</li><li><strong>Expected CTC:</strong> 8 - 9 LPA</li><li><strong>Notice Period:</strong> 15 days</li><li><strong>Current Location:</strong> Chennai</li><li><strong>Preferred Location:</strong> Anywhere</li></ul><p>Kindly find the attached resume below for further reference.</p><p>Thank you for considering my application.</p><p><br></p><h3><strong>Best regards,</strong></h3><h3><strong>Janardh K,</strong></h3><h3><strong>9444395237</strong></h3>
        `,
        emailid: '',
